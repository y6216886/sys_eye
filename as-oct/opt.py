...
class NetOption(object):
    ...
    def __init__(self):
        #  ------------ General options ---------------------------------------
        self.save_path = "/usr/home2/code/classify/"  # log path
        self.data_path = "/home/yangyifan/code/jingwen_code_oct_cropped/as-oct/"  # path for loading data set  \
        self.label_path = "/home/yangyifan/code/jingwen_code_oct_cropped/as-oct/user1-8.csv"
        ...
        self.experimentID = "3foldType=1-lr=0.001"
